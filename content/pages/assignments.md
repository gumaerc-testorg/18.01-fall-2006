...
Notes G = section G of the [Notes (Course Reader)]({{< baseurl >}}/pages/readings/course-reader)

1A-3 = Exercise 1A-3 in Section E (Exercises) of the [Notes]({{< baseurl >}}/pages/readings/course-reader) (solved in section S)
